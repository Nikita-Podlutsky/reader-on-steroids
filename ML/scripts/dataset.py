# ==============================================================================
#
#                   PyTorch Dataset для Иерархических Триплетов
#
# ==============================================================================
#
#   Что делает:
#   1. Загружает обучающие триплеты из metadata.json.
#   2. HierarchicalTripletDataset: базовая версия с заранее подготовленными данными.
#   3. HierarchicalTripletDataset2: расширенная версия с онлайн поиском сложных негативов.
#   4. Реализует hard negative mining — выбирает самые "далекие" документы из пула.
#   5. Предоставляет collate функцию для динамического паддинга батчей.
#   6. Токенизирует запросы на лету с нужной максимальной длиной.
#
#   Запуск:
#   Импортируется как модуль: from dataset import *
#
#   Используется train.py для загрузки данных при обучении
#
# ==============================================================================
...
POOL_FILE = Path("triplets_data/doc_pool.pt")          # 10k×384
